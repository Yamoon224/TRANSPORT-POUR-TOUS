...
$radioButtons.click($radioButtons.each($(this).parent().toggleClass('language-sel', this.checked)));
...
/*------------------------------------- Bookmark-------------------------------------*/
$('.item-bookmark').on('click', $(this).toggleClass('active')); 

/*------------------------------------- Mentor follow -------------------------------------*/
$(document).ready($(".mentor-select input").click(function() {
    var content = $(this);
...
$(".circle_percent").each(function() {
    ...
    if($dataV >= 51){
        ...
        setTimeout($this.addClass("percent_more"),1000);
        setTimeout($round.css("transform", "rotate(" + parseInt($dataDeg + 180) + "deg)"),1000);
    } 
});
...
$(window).on("load" , $('.loader-mask1').delay(2000).fadeOut(3000));
